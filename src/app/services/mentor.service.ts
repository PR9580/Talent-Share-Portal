...
export class MentorService {
  ...
  private baseUrl = 'http://localhost:8070/api/v1/mentor';
  private skillUrl = "http://localhost:8070/api/v1/skill/get-all-skills";
  private categoriesUrl = "http://localhost:8070/api/v1/category/get-all-categories";
